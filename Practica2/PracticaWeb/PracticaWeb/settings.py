...
SECRET_KEY = 'lag348pxsdlj$85)*w3*kvi$bdtc#)$@%=_qtszfgy@$-qx^(*'
...
INSTALLED_APPS = [
    'mediacloud.apps.MediacloudConfig',
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_PERMISSION_CLASSES': [
        'mediacloud.permissions.IsAdminOrCommentExpert'],
    'PAGE_SIZE': 20
}
