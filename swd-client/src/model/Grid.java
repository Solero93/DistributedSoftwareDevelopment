...
public class Grid {
    ...
    public boolean putShip(String position, int shipSize, boolean isHorizontal){
    ...
    public boolean invalidCell(char character , char number){
        ...
        return (cells.containsKey(character + number) || cells.containsKey(((char) (character - 1)) + number)
                || cells.containsKey(((char) (character + 1)) + number) || cells.containsKey(character + ((char) (number - 1)))
